...
DROP FUNCTION IF EXISTS nanoid(int, text, float);--> statement-breakpoint
...
UPDATE "rooms"
SET "staticSlug" = nanoid(6, 'abcdefghijklmnopqrstuvwxyz0123456789')
WHERE "staticSlug" IS NULL;--> statement-breakpoint

ALTER TABLE "rooms" ADD CONSTRAINT "rooms_staticSlug_unique" UNIQUE("staticSlug");--> statement-breakpoint

ALTER TABLE "rooms" ALTER COLUMN "staticSlug" SET NOT NULL;